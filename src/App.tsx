    ...
    <section className='vxh-paths'>
      <div className='vxh-wrap'>
        <div className='vxh-path-intro'>
          ...
          <div className='vxh-path-visual' aria-hidden='true'><img className='vxh-path-visual-bg' src='/resources/vantoryx-two-path-premium-bg.png' alt=''/></div>
        </div>
...
export default App;
/* deployment-sync: clean premium artwork hotfix */
